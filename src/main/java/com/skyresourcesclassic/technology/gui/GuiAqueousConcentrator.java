...
import com.skyresourcesclassic.technology.gui.container.ContainerAqueousConcentrator;
...
public class GuiAqueousConcentrator extends GuiContainer {

    private IInventory playerInv;
    private TileAqueousConcentrator tile;

    public GuiAqueousConcentrator(IInventory playerInv, TileAqueousConcentrator te) {
        super(new ContainerAqueousConcentrator(playerInv, te));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation(References.ModID, "textures/gui/aqueous_concentrator.png"));
