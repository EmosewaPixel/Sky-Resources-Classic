...
public class TConPlugin implements IModPlugin {
    ...
    public void init() {
        ...
        ProcessRecipeManager.combustionRecipes.addRecipe(new ItemStack(edible, 1, 2), 350,
                new ArrayList<Object>(Arrays.asList(new ItemStack(Items.SLIME_BALL), new ItemStack(Items.DYE, 2, 5))));
        ...
        ProcessRecipeManager.infusionRecipes.addRecipe(new ItemStack(sapling, 1, 0), 12,
                new ArrayList<Object>(Arrays.asList(new ItemStack(edible, 16, 1), "treeSapling")));
        ProcessRecipeManager.infusionRecipes.addRecipe(new ItemStack(sapling, 1, 1), 12,
                new ArrayList<Object>(Arrays.asList(new ItemStack(edible, 16, 2), "treeSapling")));
        ProcessRecipeManager.infusionRecipes.addRecipe(new ItemStack(sapling, 1, 2), 16,
                new ArrayList<Object>(Arrays.asList(new ItemStack(edible, 16, 4), "treeSapling")));
        ProcessRecipeManager.infusionRecipes.addRecipe(new ItemStack(dirt, 1, 0), 8,
                new ArrayList<Object>(Arrays.asList(new ItemStack(Items.SLIME_BALL, 4), new ItemStack(Blocks.DIRT))));
        ...
        SkyResourcesGuide.addPage("tinkers", "guide.skyresourcesclassic.misc", new ItemStack(edible, 1, 2));
    }
